    ...
    try:
        ...
        if query_name == "거래처등록":
            ...
            if not all([co_cd, start_date, end_date]):
                return jsonify({"error": "회사,시작일자,종료일자 모두 선택해야 합니다."}), 400
            sql = (
                "SELECT CASE WHEN H.ADJUST_FG='0' THEN '기초' WHEN H.ADJUST_FG='1' THEN '입고' WHEN H.ADJUST_FG='2' THEN '출고' END ADJUST_FG, "
            ...
            sql = (
                ...
                "T.BILL_AM, D.CT_NB, D.CT_AM, T.JEONJA_YN, T.ASSET_AM, T.ASSET_VAT, "
                ...
                "CASE WHEN D.DEPTCD_TY = 'C3' THEN D.CT_DEPT ELSE '' END CAR_CD, "
